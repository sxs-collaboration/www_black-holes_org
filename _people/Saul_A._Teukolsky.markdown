...
group: faculty
affiliations:
    - position: Hans A. Bethe Professor of Physics and Astrophysics, Emeritus
    ...
    - position: Robinson Professor of Theoretical Astrophysics
      institution: Caltech
      email: saul@caltech.edu
      address: 326 Cahill
advisor:
specialties: Theoretical Astrophysics, General Relativity, Computational Physics
---

##### Research Projects

Solving Einstein's equations for black-hole and neutron-star mergers using supercomputers.
...
general relativity by computer. One of the goals of this project is to predict the
gravitational waveform from coalescing black holes and neutron stars in binary orbit about each other.
This project uses large supercomputers
all over the country, and is being carried out in collaboration with researchers at several other
institutions.

Teukolsky's research has spanned many other topics in relativistic astrophysics. He has
...
stellar dynamics; and planets around pulsars.
...
[<a
href="http://arxiv.org/abs/2110.08635" target="_blank">http://arxiv.org/abs/2110.08635</a>]</li>
<li>Testing the Black-Hole Area Law with GW150914. M. Isi, W. M. Farr,
M. Giesler, M. A. Scheel, and S. A. Teukolsky. Phys. Rev. Lett., 127,
011103 (2021).
[<a
